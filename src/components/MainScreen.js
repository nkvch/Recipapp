                    ...
                    <div class="accordion-body">
                        <div className="row">
                            ...
                            <div className="col-sm-8 col-md-6">
                                <img className="img-fluid" src={ingredSelect} alt="Screenshot from application" />
                            </div>
                        </div>
                    </div>
                    </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-body">
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-sm-5 col-md-6 d-flex justify-content-center position-relative">
                                <a>
